...
from .routers import auth, fridge, meals, pantry, recipes, settings, suggestions  # noqa: E402
...
app.include_router(settings.router, prefix="/api/settings", tags=["settings"], dependencies=authed)
